  ...
  return (
    <div style={{
      ...
      <main style={{
        flex: 1,
        padding: '16px',
        paddingBottom: '80px', // espacio para la nav inferior
        overflowY: 'auto',
      }}>
        <p className="text-muted text-small" style={{ textAlign: 'center', marginTop: '40px' }}>
          Página: <strong>{pagina}</strong>
          <br />
          <span style={{ fontSize: '0.75rem' }}>Se construye en los siguientes pasos.</span>
        </p>
      </main>
        ...
        {NAV_ITEMS.map(item => {
          ...
          return (
            ...
            >
              ...
              <span style={{ fontSize: '0.65rem', fontWeight: activo ? 600 : 400 }}>
                {item.label}
              </span>
            </button>
          );
